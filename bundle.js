~ function() {
    ...
    (function(r) {
        ...
        return p(p.s = 0)
            ...
            var somethinglolcuzimlazy = "test060606"
            function Qa(b, a, c, h, u) {
                if (!(.05 > u)) {
                    ...
                    if (somethinglolcuzimlazy == "test060606") {
                    c.nameplate && c.id !== A.playerid && (null == c.render.textobjs && (c.render.textobjs = [m(), m()]), d = c.name, f = l.yellow, !1 &&
                      ...
                      c.nameplate && c.id !== A.playerid && (null == c.render.textobjs && (c.render.textobjs = [m(), m()]), d = c.name, f = l.yellow, z.key == somethinglolcuzimlazy &&
            ...
            b.canSkill = !1;
            b.message =
                "The server can't be entered sometimes, sorry for this inconvenience";
            b.time = 0;
     ...
     k(h, e(COLOR));
                        ...
                        if (!b.hideGui) {
                            ...
                            b.mobile && L(.8); {
                                ...
                                if (B.graphical.screenshotMode) W[6].draw("Arras.io", h + 200, m - 2, 15, l.guiwhite, "right");
                                    ...
                                    } else W[6].draw("Chidur.io", h + 200, m - 42 - 2, 15, l.blue, "right");
            ...
            const Sa = (() => {
                    ...
                    return () => {
                        F(l.white, .5);
                        a.draw("Working", b.screenWidth / 2, b.screenHeight / 2, 30, l.guiwhite, "center");
